...
@Composable
fun ProductEditionScreen(goBack: () -> Unit, accept:() -> Unit, viewModel: ProductEditionViewModel,
                          modifier: Modifier = Modifier,
                          event: ProductEditionEvent = ProductEditionEvent(
    ...
    TopAppBarTitle(
        ...
        when{
            ...
            viewModel.state.isError -> BaseAlertDialog(
                ...
                onConfirm = event.onDismissDialog,
                onDismiss = event.onDismissDialog)
            viewModel.stateView is ProductEditionStateView.Success -> ProductEdition(modifier, accept, viewModel.state, event)
        }
    }

}

data class ProductEditionEvent(
    ...
    val onClickEditProduct: (() -> Unit) -> Unit = {},
)

@Composable
fun ProductEdition(modifier: Modifier = Modifier, accept: () -> Unit, state: ProductEditionState, event: ProductEditionEvent) {
